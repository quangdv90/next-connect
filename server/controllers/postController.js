...
exports.getPostsByUser = async (req, res) => {
    const posts = await Post.find({ postedBy: req.profile._id }).sort({ createdBy: 'desc' });
...
exports.getPostFeed = async (req, res) => {
    ...
    const posts = await Post.find({ postedBy: { $in: following } }).sort({ createdBy: 'desc' });
